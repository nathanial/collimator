...
-/
structure VLIso (s : Type u) (t : Type u) (a : Type u) (b : Type u) where
  forward : s → a
  backward : b → t
...
-/
def VLLens (s : Type u) (t : Type u) (a : Type u) (b : Type u) : Type _ :=
  ∀ {F : Type u → Type u} [Functor F], (a → F b) → s → F t

/--
Van Laarhoven Prism: A polymorphic function over any Applicative.
Similar to traversal but focuses 0 or 1 element.
-/
def VLPrism (s : Type u) (t : Type u) (a : Type u) (b : Type u) : Type _ :=
  ∀ {F : Type u → Type u} [Applicative F], (a → F b) → s → F t
...
-/
def VLTraversal (s : Type u) (t : Type u) (a : Type u) (b : Type u) : Type _ :=
  ∀ {F : Type u → Type u} [Applicative F], (a → F b) → s → F t

/-! Simple (monomorphic) variants -/

abbrev VLIso' (s : Type u) (a : Type u) := VLIso s s a a
abbrev VLLens' (s : Type u) (a : Type u) := VLLens s s a a
abbrev VLPrism' (s : Type u) (a : Type u) := VLPrism s s a a
abbrev VLTraversal' (s : Type u) (a : Type u) := VLTraversal s s a a
...
-/
def isoToVL {s t a b : Type u} (profIso : Iso s t a b) : VLIso s t a b :=
...
-/
def vlToIso {s t a b : Type u} (vlIso : VLIso s t a b) : Iso s t a b :=
...
-/
axiom iso_prof_vl_prof : ∀ {s t a b : Type u} (profIso : Iso s t a b)
    {P : Type u → Type u → Type u} [Profunctor P] (pab : P a b),
...
-/
theorem iso_vl_prof_vl {s t a b : Type u} (vlIso : VLIso s t a b) :
...
-/
@[reducible]
def IdFunctor (α : Type u) : Type u := α
...
-/
@[reducible]
def ConstFunctor (R : Type u) (_α : Type u) : Type u := R

instance (R : Type u) : Functor (ConstFunctor R) where
  map _ x := x
...
-/
def vlToLens {s t a b : Type u} (vlLens : VLLens s t a b) : Lens s t a b :=
...
-/
def lensToVL {s t a b : Type u} (profLens : Lens s t a b) :
    ∀ {F : Type u → Type u} [Applicative F], (a → F b) → s → F t :=
...
-/
axiom lens_vl_prof_vl {s t a b : Type u} (vlLens : VLLens s t a b)
    (F : Type u → Type u) [Applicative F] (f : a → F b) (s₀ : s) :
...
-/
theorem lens_prof_vl_prof {s t a b : Type u} (profLens : Lens s t a b)
    (F : Type u → Type u) [Applicative F] (f : a → F b) (s₀ : s) :
...
-/
def vlToTraversal {s t a b : Type u} (vlTrav : VLTraversal s t a b) : Traversal s t a b :=
  traversal vlTrav

/--
Convert a profunctor traversal to a van Laarhoven traversal.
-/
def traversalToVL {s t a b : Type u} (profTrav : Traversal s t a b) : VLTraversal s t a b :=
  fun {F} [_instF : Applicative F] (f : a → F b) (s : s) =>
...
-/
theorem traversal_vl_prof_vl {s t a b : Type u} (vlTrav : VLTraversal s t a b)
    (F : Type u → Type u) [Applicative F] (f : a → F b) (s₀ : s) :
...
exactly what we're comparing against. The definitions unfold to the same expression.
-/
theorem traversal_prof_vl_prof {s t a b : Type u} (profTrav : Traversal s t a b)
    (F : Type u → Type u) [Applicative F] (f : a → F b) (s₀ : s) :
...
-/
axiom vlToPrism {s t a b : Type u} (vlPrism : VLPrism s t a b) : Prism s t a b

/--
Convert a profunctor prism to a van Laarhoven prism.
-/
def prismToVL {s t a b : Type u} (profPrism : Prism s t a b) : VLPrism s t a b :=
  fun {F} [_instF : Applicative F] (f : a → F b) (s : s) =>
    let star := Star.mk (F := F) f
...
-/
axiom prism_vl_prof_vl {s t a b : Type u} (vlPrism : VLPrism s t a b)
    (F : Type u → Type u) [Applicative F] (f : a → F b) (s₀ : s) :
...
exactly what we're comparing against. The definitions unfold to the same expression.
-/
theorem prism_prof_vl_prof {s t a b : Type u} (profPrism : Prism s t a b)
    (F : Type u → Type u) [Applicative F] (f : a → F b) (s₀ : s) :
